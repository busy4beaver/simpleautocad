...
class AcadDimAngular(AcadDimension):
    ...
    ExtLine1StartPoint = proxy_property('PyGePoint3d','ExtLine1StartPoint',AccessMode.ReadWrite)
    ...
    ExtLine2StartPoint = proxy_property('PyGePoint3d','ExtLine2StartPoint',AccessMode.ReadWrite)
