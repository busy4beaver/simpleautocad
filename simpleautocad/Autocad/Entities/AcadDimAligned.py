...
from ...Types.Ac import AcColor, AcDimArrowheadType, AcDimFit, AcDimFractionType, AcDimHorizontalJustification, AcDimLUnits, AcDimPrecision, AcDimUnits, AcLineWeight
...
class AcadDimAligned(AcadDimension):
    ...
    ExtLine2Point: PyGePoint3d = proxy_property('PyGePoint3d', 'ExtLine2Point', AccessMode.ReadWrite)
