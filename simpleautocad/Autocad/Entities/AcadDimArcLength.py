...
class AcadDimArcLength(AcadDimension):
    ...
    ArcPoint = proxy_property('PyGePoint3d','ArcPoint',AccessMode.ReadOnly)
    ...
    CenterPoint = proxy_property('PyGePoint3d','CenterPoint',AccessMode.ReadWrite)
    ...
    ExtLine1Point = proxy_property('PyGePoint3d','ExtLine1Point',AccessMode.ReadWrite)
    ExtLine1Suppress: bool = proxy_property(bool,'ExtLine1Suppress',AccessMode.ReadWrite)
    ExtLine2Point = proxy_property('PyGePoint3d','ExtLine2Point',AccessMode.ReadWrite)
    ...
    HasLeader: bool = proxy_property(bool,'HasLeader',AccessMode.ReadWrite)
    ...
    Leader1Point = proxy_property('PyGePoint3d','Leader1Point',AccessMode.ReadWrite)
    Leader2Point = proxy_property('PyGePoint3d','Leader2Point',AccessMode.ReadWrite)
    ...
    SymbolPosition = proxy_property('AcDimArcLengthSymbol','SymbolPosition',AccessMode.ReadWrite)
