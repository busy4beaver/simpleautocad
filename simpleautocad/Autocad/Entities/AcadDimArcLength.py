...
class AcadDimArcLength(AcadDimension):
    ...
    ArcEndParam: float = proxy_property(float, 'ArcEndParam', AccessMode.ReadWrite)
    ArcPoint: PyGePoint3d = proxy_property('PyGePoint3d', 'ArcPoint', AccessMode.ReadWrite)
    ArcStartParam: float = proxy_property(float, 'ArcStartParam', AccessMode.ReadWrite)
    CenterPoint: PyGePoint3d = proxy_property('PyGePoint3d', 'CenterPoint', AccessMode.ReadWrite)
    ...
    IsPartial: bool = proxy_property(bool, 'IsPartial', AccessMode.ReadWrite)
    Leader1Point: PyGePoint3d = proxy_property('PyGePoint3d', 'Leader1Point', AccessMode.ReadWrite)
    Leader2Point: PyGePoint3d = proxy_property('PyGePoint3d', 'Leader2Point', AccessMode.ReadWrite)
    ...
    def Copy(self) -> AcadDimArcLength:
        return AcadDimArcLength(self._obj.Copy())
