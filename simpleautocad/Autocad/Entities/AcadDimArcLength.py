...
class AcadDimArcLength(AcadDimension):
    ...
    ArcPoint: PyGePoint3d = proxy_property('PyGePoint3d','ArcPoint',AccessMode.ReadOnly)
    ...
    SymbolPosition: AcDimArcLengthSymbol = proxy_property('AcDimArcLengthSymbol','SymbolPosition',AccessMode.ReadWrite)
