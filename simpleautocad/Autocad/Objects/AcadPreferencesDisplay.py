...
class AcadPreferencesDisplay(AcadObject):
    ...
    AutoTrackingVecColor: OLE_COLOR = proxy_property('OLE_COLOR', 'AutoTrackingVecColor', AccessMode.ReadWrite)
    ...
    GraphicsWinLayoutBackgrndColor: OLE_COLOR = proxy_property('OLE_COLOR', 'GraphicsWinLayoutBackgrndColor', AccessMode.ReadWrite)
    GraphicsWinModelBackgrndColor: OLE_COLOR = proxy_property('OLE_COLOR', 'GraphicsWinModelBackgrndColor', AccessMode.ReadWrite)
    ...
    LayoutCrosshairColor: OLE_COLOR = proxy_property('OLE_COLOR', 'LayoutCrosshairColor', AccessMode.ReadWrite)
    ...
    ModelCrosshairColor: OLE_COLOR = proxy_property('OLE_COLOR', 'ModelCrosshairColor', AccessMode.ReadWrite)
